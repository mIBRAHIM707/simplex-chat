...
data ChatMsgEvent (e :: MsgEncoding) where
  ...
  XMsgRead :: SharedMsgId -> ChatMsgEvent 'Json -- NEW: Read receipt event
...
data CMEventTag (e :: MsgEncoding) where
  ...
  XMsgRead_ :: CMEventTag 'Json -- NEW: Read receipt event tag
