...
data ChatCommand
  ...
  | APISetUserReadReceipts UserId UserReadReceiptSettings
  | SetUserReadReceipts UserReadReceiptSettings
  | APISetContactReadReceipts UserId ContactId Bool
  | SetContactReadReceipts ContactName Bool
