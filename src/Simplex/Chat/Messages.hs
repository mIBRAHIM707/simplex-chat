...
data CIStatus (d :: MsgDirection) where
  ...
  CISSndRead :: CIStatus 'MDSnd -- NEW: Message was read by recipient
    ...
    where
      statusP =
        A.takeTill (== ' ') >>= \case
          ...
          "snd_read" -> pure $ ACIStatus SMDSnd CISSndRead
...
jsonACIStatus = \case
  ...
  JCISSndRead -> ACIStatus SMDSnd CISSndRead
